class AgentListFromDealer {
  ...
  Workshop get dealer => _dealer;
  set dealer(Workshop dealer) => _dealer = dealer;
  Product get product => _product;
  set product(Product product) => _product = product;

  AgentListFromDealer.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _reqId = json['req_id'];
    ...
    _dealer =
        json['dealer'] != null ? new Workshop.fromJson(json['dealer']) : null;
    _product =
